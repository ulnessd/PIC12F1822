...
main:
    ...
    movlw 0b00000001; sets RA0 to analog
    movwf ANSELA
    ...
    ;extra stuff for ADC
    BANKSEL ADCON0 ;this is bank 1
    movlw 0b00000000	;this selects adcon0 setting. see page 130 for the settings
    movwf ADCON0
...
mainloop:
    ...
    call ra2_toggle
    nop
    movlw 20  ; a momentary delay. It seems neccessary to have this slight delay
    call delay
    goto mainloop
